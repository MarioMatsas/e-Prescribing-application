...
![Διάγραμμα ακολουθίας - Ηλεκτρονική Συνταγογράφηση](./PNGs/uc1_sqDg.png)

#### Εκτέλεση Συνταγής

![Διάγραμμα ακολουθίας - Εκτέλεση Συνταγής](./PNGs/uc2_sqDg.png)

#### Ταυτοποίηση Χρήστη

![Διάγραμμα ακολουθίας - Ταυτοποίηση Χρήστη](./PNGs/uc3_sqDg.png)

#### Δημιουργία Αναφοράς

![Διάγραμμα ακολουθίας - Δημιουργία Αναφοράς](./PNGs/uc4_sqDg.png)

#### Διαχείρηση Δραστικών Ουσιών

![Διάγραμμα ακολουθίας - Διαχείρηση Δραστικών Ουσιών](./PNGs/uc5_sqDg.png)

#### Διαχείρηση Φαρμκευτικών Σκευασμάτων

![Διάγραμμα ακολουθίας - Διαχείρηση Φαρμκευτικών Σκευασμάτων](./PNGs/uc6_sqDg.png)